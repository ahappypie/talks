...
<div border="2 solid white/5" rounded-lg overflow-hidden bg="white/5" backdrop-blur-sm h-full v-click="3">
  <div flex items-center bg="white/10" backdrop-blur px-3 py-2 rounded-md>
    <div i-carbon:data-unreal text-amber-300 text-sm mr-2 />
    <div font-semibold>
  ...
  <div flex items-center px-4 py-3>
    <div flex flex-col gap-3>
      <div v-click="3">
        <div text-sm font-medium mb-2><i>All</i> rows from right table and <i>matching</i> rows from left table</div>
      </div>
      <div v-click="4">
        <img src="/right-join.svg">
      </div>
    </div>
  </div>
</div>
