    ...
    <div flex flex-col gap-8>
        <div mb-4 v-click="1">
            ...
            <div flex flex-col items-start content-start gap-4 transition duration-500 ease-in-out>
                <div flex items-center gap-2 w-fit h-fit v-click="2"><div i-ri:arrow-up-s-fill rotate-90/>Quick Review</div>
                <div flex items-center gap-2 w-fit h-fit v-click="3"><div i-ri:arrow-up-s-fill rotate-90/><code>JOIN</code></div>
                <div flex items-center gap-2 w-fit h-fit v-click="4"><div i-ri:arrow-up-s-fill rotate-90/>Aggregates</div>
                <div flex items-center gap-2 w-fit h-fit v-click="5"><div i-ri:arrow-up-s-fill rotate-90/>Subqueries</div>
                <div flex items-center gap-2 w-fit h-fit v-click="6"><div i-ri:arrow-up-s-fill rotate-90/>Common Table Expressions</div>
            </div>
        </div>
    </div>
</div>
